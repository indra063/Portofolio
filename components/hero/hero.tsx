...
const PORTRAIT_SRC = "/Model.webp";
const PORTRAIT_HOVER_SRC = "/Model2.webp";
        ...
        <div className="grid grid-cols-1 items-center gap-8 md:grid-cols-2 md:gap-8">
          <FadeIn className="flex flex-col gap-4">
            ...
            <h1 className="text-[2.75rem] font-medium leading-[1.05] tracking-tight text-foreground md:text-[2.5rem] lg:text-[3.65rem]">
              ...
              <span className="block whitespace-nowrap">Jack of All Trades</span>
            </h1>

            <p className="max-w-[34ch] text-[22px] leading-[1.4] tracking-tight text-foreground/65">
              Regular man focused on building something, one challenge at a time. Always up for the next adventure. (This is for fun).
            </p>
