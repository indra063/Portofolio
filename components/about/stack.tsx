...
const CHIPS: Chip[] = [
  ...
  { label: "ArcGis", slug: "arcgis", bg: "#1FB6CB", fg: "#ffffff" },
  { label: "QGis", slug: "qgis", bg: "#1f1f1f", fg: "#ffffff" },
  { label: "Google Maps", slug: "googlemaps", bg: "#2F74C0", fg: "#ffffff" },
  { label: "Google Earth", slug: "googleearth", bg: "#5b54ff", fg: "#ffffff" },
  { label: "Shopee", slug: "shopee", bg: "#111111", fg: "#ffffff" },
  { label: "Telegram", slug: "telegram", bg: "#0AE448", fg: "#0a0a0a" },
  { label: "Whats App", slug: "whatsapp", bg: "#181717", fg: "#ffffff" },
  { label: "Vercel", slug: "vercel", bg: "#0a0a0a", fg: "#ffffff" },
  { label: "Youtube Kids", slug: "youtubekids", bg: "#2BBCF5", fg: "#ffffff" },
  { label: "winamp", slug: "winamp", bg: "#2BBCF5", fg: "#ffffff" },
  { label: "Inkscape", slug: "inkscape", bg: "#2BBCF5", fg: "#ffffff" },
  { label: "Blender", slug: "blender", bg: "#2BBCF5", fg: "#ffffff" },
  { label: "Instagram", slug: "instagram", bg: "#2BBCF5", fg: "#ffffff" }
];
